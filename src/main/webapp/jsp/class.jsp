...
<div id="classPage" >
    ...
    <div id="classContent" class="contentBlock">
        <h1>班 级 信 息</h1>
        <h3 style="position: absolute; top: 3%; white-space: nowrap; width: 98%; text-align: right">本班总积分：<span id="classScore"></span>分</h3>
        <h4 style="position: absolute; left: 3%; top: 12%;">班级成员</h4>
        <h4 style="position: absolute; width: 95%; top: 12%; text-align: right">共<span id="classMem"></span>人</h4>
    ...
    <div id="gradeContent" class="contentBlock" style="display: none">
        <h1>年 级 信 息</h1>
        <h3 style="position: absolute; top: 3%; white-space: nowrap; width: 98%; text-align: right">本年级总积分：<span id="gradeScore"></span>分</h3>
        <h4 style="position: absolute; left: 3%; top: 12%;">所有年级</h4>
        <h4 style="position: absolute; width: 95%; top: 12%; text-align: right">全校总积分：<span id="schoolScore"></span>分</h4>
        <iframe src="../jsp/gradeList.jsp" style="position: absolute; width: 94%; left: 3%; top: 20%; height: 32%" id="gradeList"></iframe>
