...
<div id="contentArea">
    <div id="mainPart">
        ...
        <div id="infoPart">
            ...
            <br>
            <button class="mybt" style="font-size: 1.5vmax; width: 30%; margin-top: 5%; margin-left: 10%;"
                    onclick="window.location.href = '../jsp/index.jsp'">返回首页
            </button>
            <button class="mybt" style="font-size: 1.5vmax; width: 30%; margin-left: 10%"
                    onclick="window.location.href = '../jsp/order.jsp'">我的订单
            </button>
        </div>
    </div>
</div>
