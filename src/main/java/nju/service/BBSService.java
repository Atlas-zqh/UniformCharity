...
public interface BBSService {
     ...
     * @return 该板块内所有帖子
     */
    PageInfo<Post> getPostsByBoard(Integer board_id, int pageNo, int pageSize);
     ...
     * @return 该帖子所有回复
     */
    PageInfo<Reply> getRepliesByPost(Integer post_id, int pageNo, int pageSize);
     ...
     * @return 用户发过的帖子
     */
    PageInfo<Post> findPostsByUserID(String user_id, int pageNo, int pageSize);
     ...
     * @return 用户发过的回复帖
     */
    PageInfo<Reply> findReplysByUserID(String user_id, int pageNo, int pageSize);
